...
class Optimizer:
  ...
  def schedule_step(self) -> List[Tensor]:
    ...
    assert Tensor.is_train_enabled, (
            f"""Tensor.is_train_enabled={Tensor.is_train_enabled}, Tensor.is_train_enabled must be enabled to use the optimizer.
                - help: Consider setting Tensor.is_train_enabled=True before calling Optimizer.step().""")
